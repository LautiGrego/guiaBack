...
async function CrearBaseSinoExiste() {
    ...
    if (!existe) {
        await db.run(
            `CREATE table personajesDBZs ( IdPersonaje INTEGER PRIMARY KEY AUTOINCREMENT, Nombre text NOT NULL UNIQUE, NivelDePoder INTEGER NOT NULL, fechaNacimiento text, Activo Boolean, ComidaFavorita Integer, FOREIGN KEY(ComidaFavorita) REFERENCES comidas(IdComida))`
        );
        console.log("tabla de personajes de DBZ creada!");
        await db.run(
            `INSERT INTO personajesDBZs VALUES
            (1, 'Son Goku', 9000, '1963-04-16', 1, 1),
            (2, 'Vegeta', 8500, '1968-02-12', 1, 7),
            (3, 'Piccolo', 4200, 'null', 1, 2),
            (4, 'Son Gohan', 3500, '1989-05-18', 1, 2),
            (5, 'Trunks', 4000, '766-08-31', 1, 3),
            (6, 'Goten', 3000, '767-03-28', 1, 3),
            (7, 'Krillin', 1000, '1971-08-18', 1, 4),
            (8, 'Bulma', 5, '1963-08-18', 1, 4),
            (9, 'Android 18', 3500, '1987-11-12', 1, 5),
            (10, 'Frieza', 12000, 'null', 1, 5)`
